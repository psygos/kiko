...
| Camera | exact MXID, bounded nonblocking queues, calibrated intrinsics | one native OAK owner fanning RGB/stereo/depth/IMU | second dashboard pipeline, first-device fallback, silent calibration fallback |
