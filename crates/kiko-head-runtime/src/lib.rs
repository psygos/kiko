...
pub use actor::{
    ...
    VerificationSample, VerifiedHeadGoalRegisterEvidence, VerifiedHeadHealthEvidence,
    VerifiedHeadReturnEvidence, VerifiedNaturalHoldEvidence, WriteEvidence, WritePurpose,
    spawn_head_actor, spawn_head_return_actor, spawn_tension_preserving_head_return_actor,
